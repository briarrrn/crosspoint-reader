...
void OpdsBookBrowserActivity::downloadBook(const OpdsEntry& book) {
  ...
  // Always download to root first; series-folder placement happens after the download
  ...
  if (result == HttpDownloader::OK) {
    // Extract the series name from the EPUB OPF metadata and move the file into a
    // series subfolder if present. Works regardless of what the OPDS server exposes.
    ...
    Epub(finalFilename, "/.crosspoint").clearCache();
